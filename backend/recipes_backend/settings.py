...
Этот модуль содержит основные настройки Django проекта foodgram. Он включает
в себя настройки базы данных, аутентификации, настройки электронной почты,
конфигурацию статических файлов и другие настройки, необходимые для
